...
const classes = computed(() => {
  const palette: Record<string, string> = {
    ...
    sales_manager: 'border-orange-500/30 bg-orange-500/10 text-orange-300',
    service_manager: 'border-green-500/30 bg-green-500/10 text-green-300',
    warehouse_manager: 'border-yellow-500/30 bg-yellow-500/10 text-yellow-300',
